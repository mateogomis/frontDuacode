...
const MapaSedes = () => {
  ...
  useEffect(() => {
    ...
    const addLayers = (mode) => {
      ...
      L.marker([40.416775, -3.703790], { icon: DefaultIcon }) // Madrid
        .addTo(map)
        .bindPopup('<b>Sede Internacional</b><br>Madrid');

      L.marker([43.367417,  -8.400889], { icon: DefaultIcon }) // Galicia
        .addTo(map)
        .bindPopup('<b>Sede Principal</b><br>Galicia, Av. Porto da Coruña, 3, Local 3, 15003 A Coruña');

      L.marker([39.484677, -0.363434], { icon: DefaultIcon }) // Valencia
        .addTo(map)
        .bindPopup('<b>Sede Secundaria</b><br>Valencia, Av. de Catalunya, 9, Entlo, Benimaclet 46020');
    };
